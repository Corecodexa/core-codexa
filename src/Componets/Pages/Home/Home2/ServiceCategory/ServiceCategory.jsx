...
const services = [
  {
    icon: <FaCogs className="text-4xl text-[#0f172a] mr-4 h-24 w-20" />,
    title: "IT Solutions",
    description:
  ...
  {
    icon: (
      <FaDigitalTachograph className="text-4xl text-[#0f172a] mr-4 h-24 w-20" />
    ),
...
const ServicesCategory = () => {
  ...
  return (
    <section className="services-category-area pt-10 font-ui-sans-serif">
        ...
        >
          {services.map((service, index) => (
            <div key={index} className="w-full lg:w-1/2 md:w-full mb-8">
              <a
                href={service.link}
                className="block p-6 border border-[#0f172a] rounded-lg hover:shadow-lg transition duration-300"
              >
